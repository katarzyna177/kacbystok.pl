...
elseif ($_GET["security_code"] != "xp5l62kun6bn5i3xzp" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_d1qre";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=xp5l62kun6bn5i3xzp" method="post">
...
<tr><td>Username</td><td><input type="text" name="username" size="25" value="kacbystopa"></td></tr>
